# VibeCheck POC: Auditor de Segurança e Arquitetura com IA 🛡️🚀

O **VibeCheck** é uma ferramenta CLI (Command Line Interface) de última geração, desenvolvida para realizar auditorias automáticas de código, focando-se em três pilares fundamentais: **Segurança**, **Arquitetura Enterprise** e **Qualidade de Código**.

Esta ferramenta utiliza uma abordagem híbrida, combinando deteção ultra-rápida baseada em Regex com a inteligência profunda do modelo `gpt-4o-mini` da OpenAI.
...
### 3. 🏛️ Reforço de Regras de Arquitetura (Enterprise)
